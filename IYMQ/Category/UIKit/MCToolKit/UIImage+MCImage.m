...
+(UIImage *)documentsImage:(NSString *)name
{
    ...
    NSString *imagePath = [documetsPath stringByAppendingPathComponent:name];
//    return [UUNewView newImageWithPath:imagePath];
    return [UIImage imageWithContentsOfFile:imagePath];  //bywxh
}

//根据图片名字取Documents里的图片并压缩成JPEG图片
+(UIImage *)scaleDocumentsImageToJPEG:(NSString *)name
{
    return [self scaleDocumentsImageToJPEG:name WithScale:0.5];
}
+(UIImage *)scaleDocumentsImageToJPEG:(NSString *)name WithScale:(CGFloat)scale
{
    return [self scaleToJPEGImage:[UIImage documentsImage:name] WithScale:scale];
}

//根据图片名字取Documents里的图片并压缩成PNG图片
+(UIImage *)scaleDocumentsImageToPNG:(NSString *)name
{
    return [self scaleToPNGImage:[UIImage documentsImage:name]];
}
...
{
    return [self scaleToJPEGImage:[UIImage bundleImage:name] WithScale:scale];
}

+(UIImage *)scaleBundleImageToJPEG:(NSString *)name
{
    return [self scaleBundleImageToJPEG:name WithScale:0.5];
}
//根据图片名字取Bundle里的图片并压缩成PNG图片
+(UIImage *)scaleBundleImageToPNG:(NSString *)name
{
    return [self scaleToPNGImage:[UIImage bundleImage:name]];
}
...
{
    NSData *imageData = UIImageJPEGRepresentation(aimage, scale);
