...
@interface QHRootTableViewController ()<RETableViewManagerDelegate>
...
@implementation QHRootTableViewController
...
//    [self.view setFrame:(CGRect){0,108,MainWidth,MainHeight - 158}];
    ...
    // Map item to a cell
    //
        self.manager[@"QHlistItem"] = @"QHlistCell"; // which is the same as
...
- (void)addItems
{
    ...
    for (int i = 0; i < 12; i++) {
        ...
        QHlistModle *list = [QHlistModle new];
    ...
    for (QHlistModle *dictionary in items) {
        ...
        // Add item (image)
        //
        [section addItem:[QHlistItem itemWithQHlistModel:dictionary]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    QHinfoViewController *infoView = [[QHinfoViewController alloc]init];
