...
@interface CGRootTableViewController ()<RETableViewManagerDelegate>
...
@implementation CGRootTableViewController
...
- (void)viewDidLoad {
    ...
    // Map item to a cell
    //
    self.manager[@"CGlistItem"] = @"CGlistCell"; // which is the same as
...
- (void)addItems
{
    ...
    for (int i = 0; i < 12; i++) {
        ...
        CGlistModel *list = [CGlistModel new];
      
        list.nameString = @"狮山羽毛球馆";
        list.iponeNumString = @"0771-6456248";
        list.addressString = @"南宁市兴宁区望州路11号";
        list.juliString = @"8KM";
    ...
    for (CGlistModel *dictionary in items) {
        ...
        // Add item (image)
        //
        [section addItem:[CGlistItem itemWithCGlistModel:dictionary]];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    //    SHRootViewController *rootView = [[SHRootViewController alloc]init];
