...
withErrorBlock:(errorBlock)error
{
    [[self shareInatance:soapMessage] GET:url parameters:param success:^(NSURLSessionDataTask * _Nonnull task, id  _Nonnull responseObject) {
...
+ (NSString *)LGSoapMessage
{
    ...
    "<soap11:Envelope xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\" xmlns:xsd=\"http://www.w3.org/2001/XMLSchema\" xmlns:soap11=\"http://www.w3.org/2003/05/soap-envelope\">";
